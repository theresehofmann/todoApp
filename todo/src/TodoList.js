            ...
            {this.state.currentTodos.map(todo => {
                return (
                    <div className='todo'>
                        ...
                        <button className='remove-btn' onClick={() => this.deleteTodo(todo, this.state.listTodos)}> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
